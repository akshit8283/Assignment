          ...
          <div className="sidebar">
            ...
            <hr className='text-light' />
              <a href="" className="d-flex px-3 pb-3 align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="C:\Users\HP\Desktop\AXIT\Assignment\REACT\React-Projects-master\Combined Apps\public\images\me.jpg " alt="" width="32" height="32" className="rounded-circle me-2" />
                <span className='text-warning'>Akshit</span>
              </a>
